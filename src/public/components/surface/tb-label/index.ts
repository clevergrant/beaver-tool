import styles from './tb-label.scss';
import { TbSurfaceComponent, type CircuitryPorts, type SizeConstraints, type OverwritableProperty } from '../tb-surface-component';
