import type { ComponentData, SurfaceComponentDef } from '../types';

export interface SurfaceComponentsApi {
...
export const SurfaceComponents: SurfaceComponentsApi = { register, getAll, get, createConfig };
